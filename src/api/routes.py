...
def register_routes(app):
    prefix = Config.API_PREFIX # Lấy '/api' từ config
    
    app.register_blueprint(auth_bp, url_prefix=f'{prefix}/auth')
    app.register_blueprint(business_owner_bp, url_prefix=f'{prefix}/business-owners')
    app.register_blueprint(employee_bp, url_prefix=f'{prefix}/employees')
    app.register_blueprint(admin_bp, url_prefix=f'{prefix}/administrators')
    app.register_blueprint(subscription_plan_bp, url_prefix=f'{prefix}/subscription-plans')
    ...
    app.register_blueprint(unit_bp, url_prefix=f'{prefix}/units')
    app.register_blueprint(supplier_bp, url_prefix=f'{prefix}/suppliers')
    app.register_blueprint(stock_import_bp, url_prefix=f'{prefix}/stock-imports')
    app.register_blueprint(stock_import_detail_bp, url_prefix=f'{prefix}/stock-import-details')
    app.register_blueprint(inventory_check_bp, url_prefix=f'{prefix}/inventory-checks')
    ...
    app.register_blueprint(order_detail_bp, url_prefix=f'{prefix}/order-details')
    app.register_blueprint(debt_bp, url_prefix=f'{prefix}/debts')
    app.register_blueprint(payment_bp, url_prefix=f'{prefix}/payments')
    app.register_blueprint(account_report_bp, url_prefix=f'{prefix}/account-reports')
    app.register_blueprint(expense_bp, url_prefix=f'{prefix}/expenses')
    app.register_blueprint(return_order_bp, url_prefix=f'{prefix}/returns')
    app.register_blueprint(ai_assistant_bp, url_prefix=f'{prefix}/ai-assistants')
    app.register_blueprint(ai_draft_order_bp, url_prefix=f'{prefix}/ai-draft-orders')